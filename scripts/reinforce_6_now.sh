#!/bin/bash
# Launch 6 more REINFORCE runs on GPUs 0-5 for new bgrich pairs.
set +e
...
launch_reinforce 0 "bgrich_camera_binoculars"
launch_reinforce 1 "bgrich_pocketwatch_compass"
launch_reinforce 2 "bgrich_teapot_samovar"
launch_reinforce 3 "bgrich_chess_checkers"
launch_reinforce 4 "bgrich_violin_cello"
launch_reinforce 5 "bgrich_guitar_banjo"
echo "Launched 6 REINFORCE on GPUs 0-5"
